        ...
        if (!window.web3 && !window.ethereum && option.mobile) {
          return (
            <Option
              ...
              header={option.name}
              subheader={null}
              icon={assetURL('wallets/' + option.iconName)}
            />
          )
        }
        return null
          ...
          if (option.name === 'MetaMask') {
            return (
              <Option
                ...
                icon={assetURL("wallets/metamask.png")}
              />
            )
          } else {
        ...
        <UpperSection>
          ...
          <div>
            {error instanceof UnsupportedChainIdError ? (
              <h5>{i18n._(t`Please connect to the appropriate BSC network.`)}</h5>
            ) : (
        ...
        <div className="flex flex-col space-y-6">
          ...
          {walletView !== WALLET_VIEWS.PENDING && (
            <div className="flex flex-col text-center">
              <div className="text-secondary">New to BSC? &nbsp;</div>
              <ExternalLink href="https://docs.binance.org/wallets/bsc-wallets.html" color="blue">
