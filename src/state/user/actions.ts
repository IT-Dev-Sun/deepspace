...
export const updateUserReferralCode = createAction<{
  userReferralCode: string
}>('user/updateUserReferralCode')
export const updateUserReferringCode = createAction<{
  userReferringCode: string
}>('user/updateUserReferringCode')
export const updateUserReferralAddress = createAction<{
  referringAddress: string
}>('user/updateUserReferralAddress')
