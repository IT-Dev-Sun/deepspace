import { EIP_1559_ACTIVATION_BLOCK, ZERO_ADDRESS } from '../constants'
import { Currency, Percent, Router, Trade as V2Trade, TradeType } from '@deepspace-game/sdk'
...
import { useUserArcherETHTip, useUserReferralCode, useUserReferringAddress } from '../state/user/hooks'
...
export function useSwapCallArguments(
  ...
  const refAddress = useUserReferringAddress()

  const userRefCode = useUserReferralCode()

  const refAddr = userRefCode == '0x' || userRefCode == '' ? refAddress : ZERO_ADDRESS
