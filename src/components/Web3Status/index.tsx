  ...
  if (account) {
    return (
      <div
        ...
        className="flex items-center px-3 py-1 text-xs lg:text-sm text-gray-300 cursor-pointer pointer-events-auto hover bg-opacity-70 rounded-3xl bg-dark-900"
