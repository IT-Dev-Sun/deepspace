...
const FILLED = {
  ...
  gradient:
    'w-full text-high-emphesis bg-gradient-to-r from-opaque-lightpink to-opaque-purple opacity-80 hover:opacity-100 disabled:bg-opacity-80',
}
...
const OUTLINED = {
  ...
  gradient:
    'border border-transparent border-gradient-r-purple-lightpink-dark-900 opacity-60 hover:opacity-100 disabled:bg-opacity-20',
}
  ...
  return (
    <button
      className={classNames(
        ...
        'goldman-font rounded disabled:cursor-not-allowed focus:outline-none',
